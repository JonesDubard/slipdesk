  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        {/* Logo — clicking takes you back to homepage */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 w-full">
        <motion.div initial="hidden" animate="show" variants={stagger} className="max-w-3xl">
          ...
          >
            ...
            PAYE taxes to the last decimal, so you never touch a manual spreadsheet again.
          </motion.p>
...
function PayslipCard() {
  const lines = [
    ...
    { label: "PAYE Tax (LRA)",    value: "–$73.22",  color: "text-red-400" },
  ];
  return (
    <div
    ...
    >
      ...
      <div className="px-5 py-4 space-y-3">
        ...
        <p className="text-white/25 text-[9px] font-mono text-right">L$282,817.17 @ 193.5</p>
      </div>
...
const FEATURES = [
  ...
  {
    icon: Calculator,
    title: "LRA PAYE Auto-Brackets",
    desc: "The four-tier monthly PAYE schedule (0%, 5%, 15%, 25%) applied accurately on every pay run. Effective rate displayed per employee.",
    tag: "LRA Certified",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "React Query persists your in-progress pay run to IndexedDB. Internet blips won't cost you an hour of work.",
    tag: "Offline Ready",
  },
  {
    icon: BarChart3,
    title: "Instant Recalculation Grid",
    desc: "Edit any cell — rate, hours, allowances — and watch Tax, NASSCORP, and Net Pay update in real time across the whole row.",
    tag: "Live Preview",
  },
  {
    icon: FileText,
    ...
    <section id="compliance" className="py-20 sm:py-28 bg-navy noise">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <AnimateIn>
            <p className="text-em font-mono text-xs uppercase tracking-widest mb-3">LRA PAYE · NASSCORP</p>
            ...
            <p className="text-white/60 leading-relaxed mb-8 text-sm sm:text-base">
              Slipdesk implements every LRA monthly bracket and NASSCORP contribution rate
              in verified TypeScript. Each pay run is a precise, auditable record
              no rounding errors, no forgotten thresholds.
            </p>
            <div className="space-y-3">
              {[
                "NASSCORP: 4% Employee · 6% Employer on base salary",
                "PAYE converted to LRD before bracket application",
                "Tax result converted back to employee's base currency",
...
const STATS = [
  ...
  { value: "4",     unit: "tax brackets", label: "LRA PAYE, applied correctly"  },
...
function Pricing() {
  const included = [
    ...
    "Automatic LRA PAYE calculation",
